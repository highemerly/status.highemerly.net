...
const dict = {
  ...
  en: {
    ...
    bucketTooltip: '{start} – {end}',
    autoReload: 'Data is updated every 5 minutes — reload the page to see the latest',
    version: 'Version',
    releaseNotes: 'Release notes',
    releaseNotesFallback: 'Release notes for {tag} ({version} has none of its own)',
    currentStatus: 'Summary',
    servicesHeading: 'Status of each service',
    legend: 'Legend',
